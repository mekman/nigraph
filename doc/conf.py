...
# -*- coding: utf-8 -*-
#
# nigraph documentation build configuration file, created by
...
latex_documents = [
  ('index', 'nigraph.tex', 'nigraph Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'nigraph', 'nigraph Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'nigraph', 'nigraph Documentation',
   'Ariel Rokem', 'nigraph', 'One line description of project.',
   'Miscellaneous'),
]
